...
,"//select[@name='issuerCode']/option[@value='STATE_BANK_OF_TRAVANCORE']","//select[@name='issuerCode']/option[@value='LAKSHMI_VILAS_BANK_CORPORATE_NETBANKING']","//select[@name='issuerCode']/option[@value='AXIS_BANK']","//select[@name='issuerCode']/option[@value='DCB_BANK__DEVELOPMENT_CREDIT_BANK']"]
...
for name in bank:
    with open('output.csv', 'a+', newline='') as f:
        fieldnames = ['BankName', 'LeadingURL']
        writer = csv.DictWriter(f, fieldnames=fieldnames)
        writer.writeheader()
        writer.writerow({'BankName':name,'LeadingURL':[iterate(name)]})
